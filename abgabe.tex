...
\section{Einleitung}
hallo\footnote{Vgl. \cite{athey2018impact}, S.5}
hallo2\footnote{Vgl. \cite{webdevinsiderapi}, online}
...
Die gestellte Aufgabe werden wir in der gestellten Form nicht lösen. Begründung: Die Analyse der Struktur und Elemente einer WSDL, OpenAPI-Spezifikation oder eines GraphQL-Schemas kann evtl. akademisch interessant sein, hat aber keinerlei praktischen Nutzen.\\
Es gibt bereits Tools, die diese Art von Analysen automatisch durchführen können, ohne dass Entwickler Zeit damit verschwenden müssen. Zum Beispiel können Tools wie Swagger Inspector oder Postman API Network Analyzer automatisch die Struktur und Elemente einer OpenAPI-Spezifikation analysieren und Metriken wie die Anzahl der Endpunkte, Parameter und Responsecodes berechnen. \\
Eine (wie hier geforderte) rein metrische Auswertung der Struktur oder der eingesetzten Elemente in einer REST API-Spezifikation ist in der Praxis nicht zielführend. Entwickler sind vielmehr daran interessiert, wie einfach es ist, mit der API zu arbeiten, welche Funktionen sie bereitstellt und welche Datenformate sie unterstützt. \\
...
\end{itemize}
Die Frage ist ähnlich praxisfern. Kein Mensch käme doch auf die Idee die verwendete REST-Schnittstelle von der vorhandenen Spezifikation abhängig zu machen. Verfügbarkeit, Preis, Skalierbarkeit, Performanz, Sicherheit etc. sind alles ausschlaggebende Kriterien - sowie natürlich, DASS die Schnittstelle gut dokumentiert ist. Womit ist dann eher zweitrangig. Auch welche Informationen ``fehlen'' ist zwar nicht egal, aber insofern nicht zu beantworten, weil die notwendigen Informationen vom Usecase abhängen. Zudem ist in Bezug auf Rest der Markt zwischen Json Schema und Swagger/Open API aufgeteilt:\footnote{Vgl. \cite{api-postman}}
\begin{formal}
...
Deshalb erfolgt an dieser Stelle lediglich ein Vergleich zwischen den beiden (mit Differenzierung der alten und neuen Open API Versionen):

\begin{table}[h]
\centering
\begin{tabular}{|L{4cm}|L{2cm}|L{2cm}|L{2cm}|}
\hline
\textbf{Funktion} & \textbf{JSON Schema} & \textbf{Swagger 2.0} & \textbf{OpenAPI 3.0} \\ \hline
Schema-Definitionssprache & Ja & Ja & Ja \\ \hline
API-Beschreibung & Nein & Ja & Ja \\ \hline
API-Tests & Nein & Ja & Ja \\ \hline
API-Design & Nein & Ja & Ja \\ \hline
API-Visualisierung & Nein & Ja & Ja \\ \hline
API-Mocking & Nein & Ja & Ja \\ \hline
Beispielantworten & Nein & Ja & Ja \\ \hline
Beispielanfragen & Nein & Ja & Ja \\ \hline
Versionierung & Nein & Ja & Ja \\ \hline
Wiederverwendbare Komponenten & Nein & Ja & Ja \\ \hline
Sicherheitsdefinitionen & Nein & Ja & Ja \\ \hline
Unterstützung von Aufzählungen & Ja & Ja & Ja \\ \hline
Mehrfachvererbung & Ja & Nein & Ja \\ \hline
Content Negotiation & Nein & Nein & Ja \\ \hline
\end{tabular}
\caption{Hauptunterschiede zwischen JSON Schema, Swagger 2.0 und OpenAPI 3.0}
